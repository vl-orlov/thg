<div class="play_page">
    <div class="play_container">
        <h1 class="play_title">Mis Cursos</h1>
        <div class="daily_progress_card">
            <div class="daily_progress_label">Aprendido hoy</div>
        ...
        <div class="courses_grid">
            <div class="course_card course_card_pink">
                <div class="course_card_content">
                    <h3 class="course_title">HTML desde cero</h3>
                    ...
                    <div class="course_completion">
                        <div class="course_completion_text">
                            <span class="course_completion_label">Completado</span>
                            <span class="course_completion_count">14/24</span>
                        </div>
                        <button class="course_play_button course_play_button_pink" aria-label="Play course">
            ...
            <div class="course_card course_card_blue">
                <div class="course_card_content">
                    <h3 class="course_title">HTML avanzado</h3>
                    <div class="course_progress_bar">
                    ...
                    <div class="course_completion">
                        ...
                        <button class="course_play_button course_play_button_blue" aria-label="Play course">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 5V19L19 12L8 5Z" fill="white"/>
                            </svg>
                        </button>
            ...
            <div class="course_card course_card_teal">
                <div class="course_card_content">
                    ...
                    <div class="course_completion">
                        ...
                        <button class="course_play_button course_play_button_teal" aria-label="Play course">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 5V19L19 12L8 5Z" fill="white"/>
                            </svg>
                        </button>
