<div class="play_page">
    <div class="play_container">
        <div class="video_player">
            ...
            <button class="video_play_button" aria-label="Play/Pause">
            ...
            <div class="video_controls">
                ...
                <button class="video_fullscreen_button" aria-label="Fullscreen">
        ...
        <div class="course_info_card">
            <h1 class="course_info_title">HTML desde cero</h1>
            <div class="course_info_meta">4h 20m • 12 desafíos</div>
            
            <div class="course_about_section">
                <div class="course_about_header">
                    <h2 class="course_about_title">Acerca de este curso</h2>
                    <button class="course_about_toggle" aria-label="Toggle section">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 10l5 5 5-5" stroke="#1F1F39" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </button>
                </div>
                <p class="course_about_text">
            ...
            <div class="lessons_list">
                <div class="lesson_item lesson_item_completed">
                    ...
                    <div class="lesson_content">
                        <div class="lesson_header">
                            <h3 class="lesson_title">Introducción al código</h3>
                        ...
                        <div class="lesson_meta">
                            ...
                            <img src="img/icons/check_icon.svg" alt="Completed" class="lesson_check_icon">
                        </div>
                    </div>
                    <button class="lesson_play_button" aria-label="Play lesson">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="lesson_item lesson_item_active">
                    ...
                    <div class="lesson_content">
                        <div class="lesson_header">
                            <h3 class="lesson_title">Estructura básica de HTML</h3>
                        </div>
                        <div class="lesson_meta">
                            <span class="lesson_duration">6:10 mins</span>
                        </div>
                    </div>
                    <button class="lesson_play_button lesson_play_button_active" aria-label="Pause lesson">
                ...
                <div class="lesson_item lesson_item_locked">
                    ...
                    <div class="lesson_content">
                        <div class="lesson_header">
                            <h3 class="lesson_title">Desafío práctico</h3>
                        </div>
                        <div class="lesson_meta">
                            <span class="lesson_exercises">10 ejercicios</span>
                        </div>
                    </div>
                    <button class="lesson_play_button lesson_play_button_locked" aria-label="Locked lesson" disabled>
                        <img src="img/icons/button_locked_icon.svg" alt="Locked" class="lesson_lock_icon">
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="course_actions">
            <button class="course_favorite_button" aria-label="Add to favorites">
            ...
            <button class="course_start_button">Empezar/Continuar</button>
        </div>
    </div>
